...
//  std::cout << "[aobench mtl ("<<dehancer::device::get_name(device)<<")]:\t" << seconds.count() << "s "
...
//  });
//
//  std::string out_file_result = "ao-mtl-result-"; out_file_result.append(std::to_string(num)); out_file_result.append(ext);
//  {
