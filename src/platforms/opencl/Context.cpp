...
namespace dehancer::opencl {
    ...
    {
      last_error_ = clGetCommandQueueInfo(get_cl_command_queue(),
                                          CL_QUEUE_DEVICE,
                                          sizeof(cl_device_id),
                                          &device_id_,
                                          nullptr);
      ...
      last_error_ = clGetCommandQueueInfo(get_cl_command_queue(), CL_QUEUE_CONTEXT, sizeof(cl_context), &context_,
                                          nullptr);
      if (last_error_ != CL_SUCCESS) {
    ...
    cl_command_queue Context::get_cl_command_queue() const {
