...
//      }
            ...
            arg_list_({})
    {
      ...
      if (program_ == nullptr) {
        ...
        last_error = clBuildProgram(program_, 1, &device_id, "-cl-std=CL1.2 -cl-kernel-arg-info -cl-unsafe-math-optimizations -cl-single-precision-constant", nullptr, nullptr);
