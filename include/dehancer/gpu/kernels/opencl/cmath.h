...
//}
//
//inline static  int3 min(int3 a, int3 b) {
//  return make_int3(min(a.x, b.x), min(a.y, b.y), min(a.z, b.z));
//}
//
//inline static  int4 min(int4 a, int4 b) {
//  return make_int4(min(a.x, b.x), min(a.y, b.y), min(a.z, b.z), min(a.w, b.w));
//}
//
//inline static  uint2 min(uint2 a, uint2 b) {
//  return make_uint2(min(a.x, b.x), min(a.y, b.y));
//}
//
//inline static  uint3 min(uint3 a, uint3 b) {
//  return make_uint3(min(a.x, b.x), min(a.y, b.y), min(a.z, b.z));
//}
//
//inline static  uint4 min(uint4 a, uint4 b) {
...
//}
//
//inline static  int3 max(int3 a, int3 b) {
//  return make_int3(max(a.x, b.x), max(a.y, b.y), max(a.z, b.z));
//}
//
//inline static  int4 max(int4 a, int4 b) {
//  return make_int4(max(a.x, b.x), max(a.y, b.y), max(a.z, b.z), max(a.w, b.w));
//}
//
//inline static  uint2 max(uint2 a, uint2 b) {
//  return make_uint2(max(a.x, b.x), max(a.y, b.y));
//}
//
//inline static  uint3 max(uint3 a, uint3 b) {
//  return make_uint3(max(a.x, b.x), max(a.y, b.y), max(a.z, b.z));
//}
//
//inline static  uint4 max(uint4 a, uint4 b) {
...
//////////////////////////////////////////////////////////////////////////////////
//
//inline static  float __attribute__((overloadable)) clamp(float f, float a, float b) {
//  return fmaxf(a, fminf(f, b));
//}
//
//inline static  int __attribute__((overloadable)) clamp(int f, int a, int b) {
//  return max(a, min(f, b));
//}
//
//inline static  uint __attribute__((overloadable))  clamp(uint f, uint a, uint b) {
//  return max(a, min(f, b));
//}
//
//inline static  float2 __attribute__((overloadable))  clamp(float2 v, float a, float b) {
//  return make_float2(clamp(v.x, a, b), clamp(v.y, a, b));
//}
//
//inline static  float2 __attribute__((overloadable))  clamp(float2 v, float2 a, float2 b) {
//  return make_float2(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y));
//}
//
//inline static  float3 __attribute__((overloadable))  clamp(float3 v, float a, float b) {
//  return make_float3(clamp(v.x, a, b), clamp(v.y, a, b), clamp(v.z, a, b));
//}
//
//inline static  float3 __attribute__((overloadable))  clamp(float3 v, float3 a, float3 b) {
//  return make_float3(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y), clamp(v.z, a.z, b.z));
//}
//
//inline static  float4 __attribute__((overloadable))  clamp(float4 v, float a, float b) {
//  return make_float4(clamp(v.x, a, b), clamp(v.y, a, b), clamp(v.z, a, b), clamp(v.w, a, b));
//}
//
//inline static  float4 __attribute__((overloadable))  clamp(float4 v, float4 a, float4 b) {
//  return make_float4(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y), clamp(v.z, a.z, b.z), clamp(v.w, a.w, b.w));
//}
//
//inline static  int2 clamp(int2 v, int a, int b) {
//  return make_int2(clamp(v.x, a, b), clamp(v.y, a, b));
//}
//
//inline static  int2 clamp(int2 v, int2 a, int2 b) {
//  return make_int2(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y));
//}
//
//inline static  int3 clamp(int3 v, int a, int b) {
//  return make_int3(clamp(v.x, a, b), clamp(v.y, a, b), clamp(v.z, a, b));
//}
//
//inline static  int3 clamp(int3 v, int3 a, int3 b) {
//  return make_int3(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y), clamp(v.z, a.z, b.z));
//}
//
//inline static  int4 clamp(int4 v, int a, int b) {
//  return make_int4(clamp(v.x, a, b), clamp(v.y, a, b), clamp(v.z, a, b), clamp(v.w, a, b));
//}
//
//inline static  int4 clamp(int4 v, int4 a, int4 b) {
//  return make_int4(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y), clamp(v.z, a.z, b.z), clamp(v.w, a.w, b.w));
//}
//
//inline static  uint2 clamp(uint2 v, uint a, uint b) {
//  return make_uint2(clamp(v.x, a, b), clamp(v.y, a, b));
//}
//
//inline static  uint2 clamp(uint2 v, uint2 a, uint2 b) {
//  return make_uint2(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y));
//}
//
//inline static  uint3 clamp(uint3 v, uint a, uint b) {
//  return make_uint3(clamp(v.x, a, b), clamp(v.y, a, b), clamp(v.z, a, b));
//}
//
//inline static  uint3 clamp(uint3 v, uint3 a, uint3 b) {
//  return make_uint3(clamp(v.x, a.x, b.x), clamp(v.y, a.y, b.y), clamp(v.z, a.z, b.z));
//}
//
//inline static  uint4 clamp(uint4 v, uint a, uint b) {
//  return make_uint4(clamp(v.x, a, b), clamp(v.y, a, b), clamp(v.z, a, b), clamp(v.w, a, b));
//}
//
//inline static  uint4 clamp(uint4 v, uint4 a, uint4 b) {
...
//////////////////////////////////////////////////////////////////////////////////
//
//inline static  float dot(float2 a, float2 b) {
...
//}
//
//inline static  int dot(int2 a, int2 b) {
//  return a.x * b.x + a.y * b.y;
//}
//
//inline static  int dot(int3 a, int3 b) {
//  return a.x * b.x + a.y * b.y + a.z * b.z;
//}
//
//inline static  int dot(int4 a, int4 b) {
//  return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;
//}
//
//inline static  uint dot(uint2 a, uint2 b) {
//  return a.x * b.x + a.y * b.y;
//}
//
//inline static  uint dot(uint3 a, uint3 b) {
//  return a.x * b.x + a.y * b.y + a.z * b.z;
//}
//
//inline static  uint dot(uint4 a, uint4 b) {
//  return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;
//}
...
////////////////////////////////////////////////////////////////////////////////
//
//inline static  float length(float2 v) {
...
//}
//
//inline static  float length(float4 v) {
//  return sqrtf(dot(v, v));
//}
...
//inline static  float2 __attribute__((overloadable)) fabs(float2 v) {
//  return make_float2(fabs(v.x), fabs(v.y));
//}
//
//inline static  float3 __attribute__((overloadable)) fabs(float3 v) {
//  return make_float3(fabs(v.x), fabs(v.y), fabs(v.z));
//}
//
//inline static  float4 __attribute__((overloadable)) fabs(float4 v) {
//  return make_float4(fabs(v.x), fabs(v.y), fabs(v.z), fabs(v.w));
//}
//
//inline static  int2 __attribute__((overloadable)) abs(int2 v) {
//  return make_int2(abs(v.x), abs(v.y));
//}
//
//inline static  int3 __attribute__((overloadable)) abs(int3 v) {
//  return make_int3(abs(v.x), abs(v.y), abs(v.z));
//}
//
//inline static  int4 __attribute__((overloadable)) abs(int4 v) {
...
//inline static  float3 __attribute__((overloadable)) cross(float3 a, float3 b) {
...
//inline static  float __attribute__((overloadable)) smoothstep(float a, float b, float x) {
//  float y = clamp((x - a) / (b - a), 0.0f, 1.0f);
//  return (y * y * (3.0f - (2.0f * y)));
//}
//
//inline static  float2 __attribute__((overloadable)) smoothstep(float2 a, float2 b, float2 x) {
//  float2 y = clamp((x - a) / (b - a), 0.0f, 1.0f);
//  return (y * y * (make_float2(3.0f) - (make_float2(2.0f) * y)));
//}
//
//inline static  float3 __attribute__((overloadable)) smoothstep(float3 a, float3 b, float3 x) {
//  float3 y = clamp((x - a) / (b - a), 0.0f, 1.0f);
//  return (y * y * (make_float3(3.0f) - (make_float3(2.0f) * y)));
//}
//
//inline static  float4 __attribute__((overloadable)) smoothstep(float4 a, float4 b, float4 x) {
