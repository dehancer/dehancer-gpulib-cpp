...
namespace dehancer {
    ...
    class WaveformImage: public Function {
    ...
    public:
        ...
        /**
         * Get the currently processed waveform
         * @return waveform object
         */
        const math::Waveform& get_waveform() const;
        
        void set_options(const Options& options);
        
    public:
        std::shared_ptr<impl::WaveformImpl> impl_;
    };
}
